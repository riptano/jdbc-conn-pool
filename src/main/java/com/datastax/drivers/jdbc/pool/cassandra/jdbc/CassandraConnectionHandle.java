...
import com.datastax.drivers.jdbc.pool.cassandra.jdbc.proxy.RecorderAwareProxy;
...
public class CassandraConnectionHandle implements Connection {
  ...
  public Statement createStatement() throws SQLException {
    ...
    try {
      return createProxyFor(
          new CassandraStatementHandle(this.conn.createStatement(), manager, this));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
    ...
    try {
      return createProxyFor(
          new CassandraStatementHandle(
              this.conn.createStatement(resultSetType, resultSetConcurrency),
              manager,
              this));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
  ...
  public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
    ...
    try {
      return createProxyFor(
          new CassandraStatementHandle(
              this.conn.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability),
              manager,
              this));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
  ...
  private <T> T createProxyFor(T obj) {
    return (T) RecorderAwareProxy.newInstance(obj);
  }
   ...
   */
  public PreparedStatement createInternalPrepareStatement(String sql) throws SQLException {
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql, autoGeneratedKeys), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql, columnIndexes), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public PreparedStatement prepareStatement(String sql, String[] columnNames)
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql, columnNames), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql, resultSetType, resultSetConcurrency), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType,
    ...
    try {
      return createProxyFor(
          new CassandraPreparedStatementHandle(
              this.conn.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), manager, this, sql));
    } catch (SQLException e) {
      throw markPossiblyBroken(e);
    }
  }
